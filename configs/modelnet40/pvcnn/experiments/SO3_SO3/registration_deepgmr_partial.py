...
from datasets.deepgmr_partial import ModelNet40_registration, MeterModelNet40_registration, test_registration
configs.evaluate.meters['eval-acc_{}'] = Config(MeterModelNet40_registration)
configs.evaluate.fn = test_registration
configs.evaluate.other_dataset = Config(ModelNet40_registration, split=['train', 'valid', 'test'], root = "/home/zebai/datasets/modelnet40_normal_resampled", shapenum = 40, num_points = 1024, max_degree=360, max_amp=0.8)
