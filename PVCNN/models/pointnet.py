...
class PointNet(nn.Module):
    ...
    num_classes = 13
    voxel_shape = 'cube'
    def __init__(self, voxel_shape=voxel_shape, num_classes=num_classes, extra_feature_channels=3, width_multiplier=1):
        super().__init__()
        self.in_channels = extra_feature_channels + 3

        layers, channels_point, _ = create_pointnet_components(blocks=self.blocks, voxel_shape=voxel_shape, in_channels=self.in_channels,
