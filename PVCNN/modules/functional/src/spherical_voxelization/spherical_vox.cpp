#include "spherical_vox.hpp"
#include "spherical_vox.cuh"
...
std::vector<at::Tensor> spherical_avg_voxelize_forward(const at::Tensor features,
  ...
  spherical_avg_voxelize(b, c, n, r, r2, r3, coords.data_ptr<float>(),
...
at::Tensor spherical_avg_voxelize_backward(const at::Tensor grad_y,
  ...
  spherical_avg_voxelize_grad(b, c, n, s, indices.data_ptr<int>(), cnt.data_ptr<int>(),
